...
@section('title', 'Input Jaringan Distribusi')
@section('content')
...
<div class="col-lg-12 grid-margin stretch-card">
  <div class="card">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item"><a class="nav-link" href="/gardis/add">Gardu Distribusi</a></li>
    </ul>
    <div class="card-body">
        <form class="forms-sample">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="unit_kerja" name="tipe_jaringan_distribusi">
                        <option value="" selected disabled>Pilih Tipe Jaringan Distribusi</option>
                        <option value="Tipe jaringan A">Tipe jaringan A</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="area" placeholder="Masukkan Panjang Jaringan" name="panjang_jaringan">
                </div>
            </div>
